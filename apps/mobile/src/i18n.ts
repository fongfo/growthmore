...
const messages: Record<Locale, Messages> = {
  "zh-CN": {
    ...
    "action.retryModule": "重试 {module}",
    "action.enterDemo": "进入离线演示",
    "action.exitDemo": "返回业务数据",
    ...
    "api.demo.title": "离线演示模式",
    "api.demo.body": "以下余额和记录仅为示例，不会保存，也不代表当前账户事实。",
  ...
  "en-US": {
    ...
    "action.retryModule": "Retry {module}",
    "action.enterDemo": "Open Offline Demo",
    "action.exitDemo": "Return to Account Data",
    ...
    "api.moduleError": "{module}: {error}",
    "api.demo.title": "Offline Demo Mode",
    "api.demo.body": "Balances and records below are examples. They are not saved and do not represent the current account.",
